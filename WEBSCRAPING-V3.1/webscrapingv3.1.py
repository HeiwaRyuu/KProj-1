...
for code in list_of_codes:
    ...
    try:
        ...
        ## Grabbing due date
        due_date_element = driver.find_element_by_xpath('//*[@id="root"]/div/header/div[2]/div/div[3]/div[6]/div[2]')
        ...
        code_and_download_link.append((code, download_link, fiduciaria[0], units, emission_date, due_date))
...
for code in list_of_codes:
    ...
    try:
        ...
        ## Grabbing due date
        due_date_element = driver.find_element_by_xpath('//*[@id="__next"]/div/section[1]/section/section[2]/div[1]/div[3]/h4')
        due_date = due_date_element.text
        ...
        ## Appending the CETIP code and download link to the list that wil pair them
        code_and_download_link.append((code, download_link, fiduciaria[1], units, emission_date, due_date))
...
df_cols = ['CETIP', 'Link' , 'Fiduciaria', 'Quantidade de Ativos', 'Data Emissão', 'Data Vencimento']
df = pd.DataFrame(code_and_download_link, columns=df_cols)

## Creating a CSV from the data collected
df.to_excel('links_for_download.xlsx', encoding='utf8', index=False)
