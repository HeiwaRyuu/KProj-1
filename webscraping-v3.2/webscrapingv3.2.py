...
for code in list_of_codes:
    ...
    ## Telling the driver to find the element we need (with XPath) - INPUT ELEMENT
...
for code in list_of_codes:
    ...
    try:
        ...
        # this loop checks if theres any of these indexes associated with the tax, if there is, we use it as our index value
