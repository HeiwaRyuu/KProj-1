...
links_csv = pd.read_excel('links_for_download.xlsx')
...
sum_last_day_of_month_values = concatenated_list_of_df.groupby(['Fiduciaria', 'CETIP', 'Data', 'Valor Nominal', 'P.U.'])[['Amortização', 'Pagamento de Juros', 'Total']].sum().reset_index()
...
sum_last_day_of_month_values.to_excel('OT_V_TEST-1.xlsx', encoding='utf8', index=False)
